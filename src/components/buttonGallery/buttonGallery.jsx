...
const ButtonGallery = () => {
    ...
    return (
        <div className="flex flex-col p-8 gap-y-3 bg-gradient-to-br from-blue-800 via-slate-800 to-blue-600">
            <a href="/">
                <button
            ...
            <Button text="New" color="red" handleButtonClick={handleButtonClick} active={active} />
        </div>
    );
};
